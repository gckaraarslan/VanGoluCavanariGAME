...
public class Boss : MonoBehaviour
{
    ...
    //    allWayPointsList.AddRange(GameObject.FindGameObjectsWithTag("Waypoints"));  //addrange= multi add...
    //}
    ...
    //            if (currentAttackTime>=attackRate)
    //            {
    //                int index = Random.Range(1, 3); //zaten 1 ve 2 var birisini rastgele seç diyoruz ve ona set ediyoruz Attack animatörünü
    ...
    //    agent.SetDestination(pos.transform.position);   //o random pointimizi set edicek hedefe...
    //}
    //private GameObject GetRandomPoint()
    //{
    //     int index=Random.Range(0,allWayPointsList.Count);  //bu range içindeki bir sayýyý RASTGELE SEÇ...
    //    return allWayPointsList[index]; //o rastgele seçilen sayý kaçýncý index ise o point'i al/dönder...
    //}
